...
const Register = ({ setUser }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.success("Registration successful! Welcome to Teamacy.");
      navigate('/');
    } catch (error) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 right-1/4 w-[600px] h-[600px] bg-accent/20 rounded-full blur-[150px] glow-effect" />
      ...
      >
        <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-heading font-bold text-white" data-testid="register-title">Create Account</h2>
            <p className="text-muted-foreground mt-2">Join Teamacy today</p>
          </div>
